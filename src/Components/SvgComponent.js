...
const SvgComponent = (props) => (
  <Svg
    ...
    viewBox="0.277 0.277 281.9 299.977"
    {...props}
  >
    <Rect
      width={5040}
    ...
    <Path
      ...
      strokeWidth={1.89}
      d="m417.6 396.7-3.1 6.7.3 3.3-2 5.7-.7 6.1 11.7-2.4 12 .8-.1 2.1-.8 1.9-.3 1.5.5 1.2.3 2-.3 2.1-.7 1.9-3.6-.3-17.5 4.8-10.8 3-14.4-2.9 1.4-4.1 2.4-2.3-.5-29.9 3.7-10.2 22.5 9Z"
      className="sm_state sm_state_KOR5129 Sejong"
      style={{
        WebkitTapHighlightColor: "transparent",
        opacity: 1,
        cursor: "pointer",
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.89}
      d="m368.2 668.9 8.1 3.1 3.2 8.9-6.2 8.3-9.8-1.6-8.6-5.2-4.3-9.5 3.4-3.2 5.7 1.5 4.1-1 4.4-1.3Z"
      className="sm_state sm_state_KOR2500 Gwangju"
      style={{
        WebkitTapHighlightColor: "transparent",
        opacity: 1,
        cursor: "pointer",
    ...
    <Path
      ...
      className="sm_state sm_state_KOR2505 South Gyeongsang"
      style={{
        WebkitTapHighlightColor: "transparent",
        opacity: 1,
        cursor: "pointer",
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.89}
      d="m656.6 550.7-2.5 2.6-1.1-.4-1.5.1v1.3l-.2 1.7-1.5 3.9v1.2l-.4 1.9-3.6 2.1-9.1-2.4-5.1-.5-2.3 1.8-2.2 4-1.3 1-1.4-1.2-2-1.3-2.8-2.3-1.8-3.6-2.3-2.3-2.5-.9-.9-3.6 2.1-3.1h2.4l2.6-.4.6-1.9.3-1.9-1.4-.5-1.5-.3 1.7-3.8 2.8-3-1-8.9 7.4-6.2 10.1-1.4 8.3-.5 6.4 4.6 2 3.5-.1 1.6-.8 1.3.1 4.9 1.3 2 1.7 1.4.3 3.1.1 3.3-.9 3.1Z"
      className="sm_state sm_state_KOR2504 Daegu"
      style={{
        WebkitTapHighlightColor: "transparent",
        opacity: 1,
        cursor: "pointer",
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.89}
      d="m434.4 429.6-.4 1.5.6 1.5 1.1 1.2 1.4.7.9 2.2-.6 3.4 4.8 1.4 5.1-1.2 1.8-2.6 2.2.5-.2 2.2 1.9 1.1.3 3.5 1.6 5.2-.7 4.6-2.1 3.4-2.3 8.5-4.1 3.3-2.3.8-6.9 5.1-7.8 2.1-3.3-10.7-.8-14.3-2.9-5.6-8.4-13.3 17.5-4.8 3.6.3Z"
      className="sm_state sm_state_KOR2503 Daejeon"
      style={{
        WebkitTapHighlightColor: "transparent",
        opacity: 1,
        cursor: "pointer",
    ...
    {/* <Rect
      ...
      transform="translate(75.584 41.793) scale(.2797)"
    /> */}
  </Svg>
)
