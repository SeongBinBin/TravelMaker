...
function MapTabStack({ navigation, records, createdAt }){

  return(
      <Tab.Navigator
        initialRouteName = "TravelRecord"
        screenOptions={{tabBarActiveTintColor: Colors.black}}
      >
        <Tab.Screen name="TravelRecord" children={(props) => 
          <TravelRecord {...props} records={records} createdAt={createdAt}/>
          } 
          options={{
            title: '홈',
